...
import Login, {loader as loginInLoader, action as loginAction} from "./pages/Login/Login";
...
const router = createBrowserRouter(
  createRoutesFromElements(
    ...
    <Route path="/" element={<Layout />} >
      ...
      <Route path="login" element={<Login />} loader={loginInLoader} action={loginAction}/>
      <Route
        path="vans"
        loader={vansLoader}
        element={<Vans />}
